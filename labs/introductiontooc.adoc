...
image::images/ocintro1.png[Correct response from oc]
...
image::images/ocintro2.png[Correct response from oc new-project]
...
image::images/ocintro3.png[Correct response from projects commands]
...
image::images/ocintro4.png[Full definition of Pod]
...
image::images/ocintro6.png[oc status output]
...
image::images/ocintro7.png[working pods]
...
image::images/ocintro8.png[working pods for app2]
...
image::images/ocintro9.png[all the pods for the two apps]
...
image::images/ocintro10.png[manual pod listing]
