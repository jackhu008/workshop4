...
image::images/odo-1.png[odo in the development cycle]
...
image::images/odo-2.png[odo in the development cycle - detail]
...
image::images/odo-3.png[odo in the development cycle - detail]
