...
image::images/camekknativeserving-1.png[Integrations running]
...
image::images/camekknativeserving-2.png[Viewing overview of running Integration]

Click on 'View Logs'

You should see a screen similar to the one below

image::images/camekknativeserving-3.png[Running Pod]

Click on the row name e.g. greetings-xxxxxxxxxxxx

This should show you a screen similar to the one below

image::images/camekknativeserving-4.png[Pod Details]

Click on 'Logs' to view the log for the pod. It should look something like the one below

image::images/camekknativeserving-5.png[Pod Details]
...
image::images/camekknativeserving-6.png[Knative serving]
...
image::images/camekknativeserving-8.png[Knative serving]
...
image::images/camekknativeserving-7.png[Knative serving started]
...
image::images/camekknativeserving-9.png[Knative serving revisions]
...
image::images/camekknativeserving-10.png[Topology view]
...
image::images/camekknativeserving-11.png[Revision view]
...
image::images/camekknativeserving-12.png[Revision Routing split]
...
image::images/camekknativeserving-13.png[Change Routing split]
