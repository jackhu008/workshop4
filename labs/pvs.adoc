...
image::images/pvs-1.png[Active Application]
...
image::images/pvs-2.png[df with no pv]
...
image::images/pvs-4.png[create new claim]
...
image::images/pvs-5.png[deployment]
...
image::images/pvs-6.png[scaled down application]
