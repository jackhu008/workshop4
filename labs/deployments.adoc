...
image::images/deployment-1.png[Deployment Configs]
...
image::images/deployment-2.png[Scaling the Deployment]
...
image::images/deployment-3.png[Editing the DC YAML]
...
image::images/deployment-4.png[Example Config Map YAML]
...
image::images/deployment-5.png[Injected config map environment variables]
...
image::images/deployment-6.png[terminal output]
...
image::images/deployment-7.png[code insert]
...
image::images/deployment-8.png[second code insert]
