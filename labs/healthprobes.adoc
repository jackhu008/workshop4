...
image::images/healthprobes-1.png[Project creation]
...
image::images/healthprobes-2.png[Deployment configuration resource information]
...
image::images/healthprobes-3.png[View of the health probe in the Deployment Configuration]
...
image::images/healthprobes-4.png[Pod events showing activation of the liveness probe]
...
image::images/healthprobes-5.png[Pod events showing activation of the readiness probe]
...
image::images/healthprobes-6.png[Pod events showing activation of the readiness probe]
