...
image::images/pipelines-2.png[Example Pipelines UI]
...
image::images/pipelines-3.png[Pipeline view showing a completed pipeline run]
...
image::images/pipelines-4.png[Pipelinerun in progress]
...
image::images/pipelines-5.png[Task and resource relationship]
